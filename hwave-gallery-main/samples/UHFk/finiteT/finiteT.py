...
for Tidx, T in enumerate(Tround_list):
  ...
  #Comment: "initial.dat.npz" is used as the initial Green's function at the first step (Tidx=0).
  #In "initial.dat.npz", a staggered antiferromagnetic configuration along the z axis is defined.
  if Tidx > 0:
